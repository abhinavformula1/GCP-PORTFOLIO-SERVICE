...
function buildSystemPrompt() {
  return [
    ...
    '   only answer it when live web search context is explicitly supplied elsewhere in the',
    '   prompt for fresh external facts. Otherwise say so honestly and direct the visitor to',
