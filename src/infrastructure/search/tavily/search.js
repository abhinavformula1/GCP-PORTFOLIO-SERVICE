...
function createTavilySearch({ config, fetchImpl = fetch }) {
if (!config || !config.tavily) {
  throw new TypeError('tavilySearch.config.tavily is required');
}
if (typeof fetchImpl !== 'function') {
  throw new TypeError('tavilySearch.fetchImpl must be a function');
}
...
module.exports = { createTavilySearch };
