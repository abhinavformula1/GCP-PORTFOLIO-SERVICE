...
function createSponsorshipsRepository({ firestore }) {
if (!firestore || typeof firestore.getDb !== 'function') {
  throw new TypeError('sponsorshipsRepository.firestore.getDb is required');
}
...
module.exports = { createSponsorshipsRepository };
