...
function createSponsorBannerRepository({ firestore }) {
if (!firestore || typeof firestore.getDb !== 'function') {
  throw new TypeError('sponsorBannerRepository.firestore.getDb is required');
}
...
module.exports = { createSponsorBannerRepository };
