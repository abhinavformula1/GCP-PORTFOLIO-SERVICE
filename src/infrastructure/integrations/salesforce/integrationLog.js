...
function createIntegrationLogger({ getToken, sfRequest }) {
if (typeof getToken !== 'function') {
  throw new TypeError('integrationLogger.getToken is required');
}
if (typeof sfRequest !== 'function') {
  throw new TypeError('integrationLogger.sfRequest is required');
}
...
async function writeLog(entry) {
  ...
  return Object.freeze({ writeLog });
}

module.exports = { createIntegrationLogger };
