...
function createPdfGenerator({ runtime, puppeteerClient = puppeteer }) {
if (!runtime || typeof runtime !== 'object') {
  throw new TypeError('pdfGenerator.runtime is required');
}
if (!puppeteerClient || typeof puppeteerClient.launch !== 'function') {
  throw new TypeError('pdfGenerator.puppeteerClient.launch is required');
}
...
async function generatePdf(url, settleMs = 1000) {
  ...
  return Object.freeze({ generatePdf, resolveChromePath, checkChrome });
}
