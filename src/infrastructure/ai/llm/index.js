...
const { LLM_MODELS, DEFAULT_LLM_MODEL_KEY, resolveModel } = require('../../../domain/llm/models');

function createLlmGateway({ getProvider }) {
if (typeof getProvider !== 'function') {
  throw new TypeError('llmGateway.getProvider is required');
}
