...
function createRecommendationService(dependencies) {
  assertDependencies(dependencies, 'application.salesforce.recommendation', { getToken: 'function', invalidateToken: 'function', isConfigured: 'function', sfApexPost: 'function', sfApexDelete: 'function', withRetry: 'function', isTransientSalesforceError: 'function' });
  const { getToken, invalidateToken, isConfigured, sfApexPost, sfApexDelete, withRetry, isTransientSalesforceError } = dependencies;
...
async function deleteRecommendation(data, opts = {}) {
  ...
  return { upsertRecommendation, deleteRecommendation };
}
