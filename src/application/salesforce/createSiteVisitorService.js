...
function createSiteVisitorService(dependencies) {
  assertDependencies(dependencies, 'application.salesforce.siteVisitor', { getToken: 'function', invalidateToken: 'function', isConfigured: 'function', sfPatch: 'function' });
  const { getToken, invalidateToken, isConfigured, sfPatch } = dependencies;
...
module.exports = { createSiteVisitorService };
