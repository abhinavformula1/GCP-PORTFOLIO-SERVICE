...
function createRecruiterQuestionService(dependencies) {
  assertDependencies(dependencies, 'application.salesforce.question', { getToken: 'function', invalidateToken: 'function', isConfigured: 'function', sfApexPost: 'function', withRetry: 'function', isTransientSalesforceError: 'function' });
  const { getToken, invalidateToken, isConfigured, sfApexPost, withRetry, isTransientSalesforceError } = dependencies;
...
module.exports = { createRecruiterQuestionService };
