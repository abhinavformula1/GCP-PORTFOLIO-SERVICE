...
function createRagService(dependencies) {
  assertDependencies(dependencies, 'application.rag', { embedText: 'function', saveChunks: 'function', deleteChunksForArticle: 'function', findNearestChunks: 'function', adminConfig: ['getAtlasConfig'], keywordSearch: 'function', upsertKeywordChunks: 'function', deleteKeywordChunksByArticle: 'function', rerankIfConfigured: 'function' });
  const { embedText, saveChunks, deleteChunksForArticle, findNearestChunks, adminConfig, keywordSearch, upsertKeywordChunks, deleteKeywordChunksByArticle, rerankIfConfigured } = dependencies;
...
const { chunkArticle }         = require('../../domain/rag/chunkArticle');
