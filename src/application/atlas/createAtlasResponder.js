...
function createAtlasResponder(dependencies) {
  assertDependencies(dependencies, 'application.atlasResponder', { generateChatResponse: 'function', generateChatResponseStream: 'function', LLM_MODELS: 'value', DEFAULT_LLM_MODEL_KEY: 'value', traceIfEnabled: 'function', previewText: 'function', summarizeGenerationConfig: 'function', summarizeUsage: 'function', summarizeStreamEvents: 'function', shouldCapturePrompts: 'function' });
  const { generateChatResponse, generateChatResponseStream, LLM_MODELS, DEFAULT_LLM_MODEL_KEY, traceIfEnabled, previewText, summarizeGenerationConfig, summarizeUsage, summarizeStreamEvents, shouldCapturePrompts } = dependencies;
 ...
 *
 * The route layer (src/interfaces/http/routes/atlas.js) handles auth, rate limiting,
...
module.exports = { createAtlasResponder };
