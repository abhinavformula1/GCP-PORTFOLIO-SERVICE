...
export const els = {
  ...
  atlasRagReindexBtn:         g('atlasRagReindexBtn'),
  atlasRagReindexStatus:      g('atlasRagReindexStatus'),
  ...
  atlasKeywordSearchProvider: g('atlasKeywordSearchProvider'),
  atlasFusionStrategy:        g('atlasFusionStrategy'),
  atlasRrfK:                  g('atlasRrfK'),
  atlasRerankerProvider:      g('atlasRerankerProvider'),
  atlasRerankerModel:         g('atlasRerankerModel'),
  atlasRerankerTopN:          g('atlasRerankerTopN'),
