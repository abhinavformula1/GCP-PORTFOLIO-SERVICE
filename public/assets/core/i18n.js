...
export const PAGE_LANG = {
  en: {
    ...
    aboutMe: 'About Me',
    about1: 'Senior Application Engineer with 12+ years of experience building scalable enterprise systems across Salesforce and GCP, with hands-on production experience designing and deploying GenAI systems — including RAG pipelines, LLM evaluation frameworks, and AI observability tooling.',
  ...
  fr: {
    ...
    aboutMe: 'À Propos',
    about1: 'Ingénieur Senior en Applications Salesforce avec plus de 12 ans d\'expérience en développement, architecture et DevOps Salesforce, spécialisé dans la création d\'applications d\'entreprise évolutives avec Apex, Lightning Web Components et des intégrations API.',
